{{-- ═══════════════════════════════════════════════════════════════
     TAB: REKAPITULASI PEMBAYARAN
     Konten dari admin/payment-report/index.blade.php
═══════════════════════════════════════════════════════════════ --}}
...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-brand-100 p-6">
        <form method="GET" action="{{ route('admin.report-center.index') }}" class="flex flex-wrap items-end gap-3">
            ...
            <a href="{{ route('admin.report-center.index', ['tab' => 'payment']) }}" class="bg-slate-200 hover:bg-slate-300 text-slate-700 px-4 py-2 rounded-lg font-bold text-sm transition-all">Hari Ini</a>
