...
<div class="max-w-7xl mx-auto space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-3xl p-6 border border-brand-100 shadow-sm relative overflow-hidden">
            ...
            <p class="text-3xl font-black text-brand-900 relative z-[1]">Rp{{ number_format($totalRevenueAllTime, 0, ',', '.') }}</p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-6 border border-brand-100 shadow-sm relative overflow-hidden">
            ...
            <p class="text-3xl font-black text-brand-900 relative z-[1]">Rp{{ number_format($totalRevenueThisMonth, 0, ',', '.') }}</p>
        </div>
        ...
        <div class="bg-white rounded-3xl p-6 border border-brand-100 shadow-sm relative overflow-hidden">
            ...
            <p class="text-3xl font-black text-brand-900 relative z-[1]">{{ number_format($totalOrdersAllTime, 0, ',', '.') }} <span class="text-sm font-medium text-slate-500">pesanan</span></p>
        </div>
    </div>
