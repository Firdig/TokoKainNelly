    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-brand-800">
            ...
            <div class="md:col-span-1">
                <img src="{{ asset('images/logo.jpg') }}" alt="Toko Kain Nelly" class="h-16 w-auto rounded-xl object-contain bg-white mb-4">
                ...
                <!-- Social Media Icons (Hanya IG dan WA) -->
                <div class="flex gap-3">
                    ...
                    <a href="https://wa.me/6281234567890" target="_blank" class="w-9 h-9 bg-green-700/50 hover:bg-green-600 rounded-lg flex items-center justify-center text-green-300 hover:text-white transition-all border border-green-700/50" title="WhatsApp">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm text-brand-400">
                    <li><a href="{{ route('home') }}" class="hover:text-brand-200 transition-colors">Beranda</a></li>
                    <li><a href="{{ route('katalog') }}" class="hover:text-brand-200 transition-colors">Katalog Kain</a></li>
                    <li><a href="{{ route('about') }}" class="hover:text-brand-200 transition-colors">Tentang Kami</a></li>
                    <li><a href="{{ route('contact') }}" class="hover:text-brand-200 transition-colors">Hubungi Kami</a></li>
                </ul>
            </div>
            <!-- Cabang -->
            <div>
                ...
                <ul class="space-y-2.5 text-sm text-brand-400">
                    <li class="flex items-start gap-2">
                        ...
                        <span>Pasar Besar Malang <span class="text-brand-600 text-xs">(Pusat)</span></span>
                    </li>
                    <li class="flex items-start gap-2">
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm text-brand-400">
                    <li class="flex items-start gap-2">
                        ...
                        <span>0821-3333-1111 (Pusat)</span>
                    </li>
                    <li class="flex items-start gap-2">
