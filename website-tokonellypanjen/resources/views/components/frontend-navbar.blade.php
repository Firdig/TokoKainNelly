...
<div x-data="{ mobileMenuOpen: false }" class="flex items-center">
    ...
    <div x-show="mobileMenuOpen" x-transition.opacity @click.away="mobileMenuOpen = false" class="absolute top-20 left-0 w-full bg-white border-b border-brand-100 shadow-xl md:hidden flex flex-col z-50 font-outfit" style="display: none;">
        <div class="px-4 py-2 flex flex-col">
            ...
            @else
                <div class="flex flex-col gap-3 py-4">
                    <a href="{{ route('login') }}" class="btn-outline text-center w-full">Masuk</a>
                    <a href="{{ route('register') }}" class="btn-primary text-center w-full">Daftar</a>
                </div>
            @endauth
        </div>
    </div>
