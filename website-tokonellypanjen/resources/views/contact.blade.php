    ...
    <main class="flex-1 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-3 gap-6 mb-16">
                ...
                <a href="https://wa.me/6281234567890" target="_blank" class="block bg-white rounded-3xl p-8 shadow-sm border border-brand-100 text-center hover:shadow-lg transition-shadow group">
                    <div class="w-14 h-14 bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-5 text-green-600 group-hover:scale-110 transition-transform">
                    ...
                    <span class="block text-green-600 font-bold text-lg group-hover:text-green-700 transition-colors">Chat Sekarang</span>
